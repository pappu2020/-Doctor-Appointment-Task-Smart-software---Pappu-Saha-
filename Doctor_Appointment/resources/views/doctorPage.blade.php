                        ...
                        @foreach ($alldoctorInfo as $key => $doctorInfo)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-success" value="{{ $doctorInfo->id . ',' . 'Available' }}" type="submit"
                                        name="stutusButton" class="dropdown-item btn-primary">Available</button>
                                    <button type="submit" class="btn btn-danger" value="{{ $doctorInfo->id . ',' . 'Not Available' }}" type="submit"
